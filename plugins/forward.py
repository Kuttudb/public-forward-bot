...
async def forward(bot, message):
    ...
    global MessageCount
    mcount = random.randint(1, 1)
    acount = random.randint(1, 1)
    bcount = random.randint(1, 1)
    ccount = random.randint(1, 1)
